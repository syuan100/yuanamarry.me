...
app.post('/admin/db/set_additional_guests', auth, function(req,res){
  ...
  console.log("1 " + JSON.parse(JSON.stringify(req.body)));
  console.log("2 " + JSON.parse(JSON.stringify(req.body)))["0"].email);
  console.log("1 " + JSON.parse(JSON.stringify(req.body)))["0"]["email"]);
